          ...
          <form className="space-y-4 w-full max-w-md" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              />
                 <label
                htmlFor="idProof"
                className="cursor-pointer border border-[#040404] bg-[#f1f1f1] text-blue-600 px-4 py-2 rounded-full font-[open_Sans] font-medium hover:bg-blue-50 transition inline-block"
              >
                {idProof ? `File Uploaded: ${idProof.name}` : "Select File"}
              </label>
            </div>
