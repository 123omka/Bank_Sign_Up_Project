...
const SelfSignUp = () => {
  ...
  return (
    ...
    <div  className='absolute top-[374px] left-[374px] '>
        ...
        <form>
            <input type="text" placeholder='South Africian Mobile Number' className='  w-[358px] h-[84px0] rounded-xl p-[10px] border border-[#040404] bg-[#f1f1f1]'/>
            <p className='font-[open_Sans]' >We'll send you a One-Time-PIN(OTP) via SMS to verify<br/> your number</p>
            <button  onClick={gotosignUp} className='w-[157.125px] h-[51px] mt-[30px] opacity-100 rounded-[1000px] font-[open_Sans] border-2 px-[20px] py-[10px] bg-lime-500'>Send OTP </button>
        </form>
