...
const Otpverification = () => {
  ...
  return (
    ...
    <div className="absolute top-[374px] left-[374px]">
      {/* Title */}
      <strong className="block w-[358px] h-[28px] font-bold text-[24px] font-[open_Sans] leading-[28px] font-['Open_Sans']">
        Enter Your OTP
      </strong>
      ...
      <form className="flex flex-col space-y-4">
        ...
        <button onClick={gotoPersonalInfo}
          type="submit"
          className="w-[157.125px] h-[51px] opacity-100 rounded-[1000px] border-2 px-[20px] py-[10px] bg-lime-500 text-black font-semibold hover:bg-lime-400 transition"
        >
          Send OTP
        </button>
      </form>
